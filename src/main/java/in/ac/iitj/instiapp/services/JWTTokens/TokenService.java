...
//                .claim(KEYS_STATE, STATES.STATE_APPROVED.toString())  //  This is the KEY fix
//                .expirationTime(new java.util.Date(System.currentTimeMillis() + ExpirationDuration.MEDIUM.getDuration()))
//                .issueTime(new java.util.Date())
//                .subject(args[0]) // username
//                .build();
//
//
...
//
//
//    public void generateAndSaveTokens(JWEAuthenticationToken jweAuth,
//                                      SignupDto signupDto,
//                                      Long userId,
//                                      HttpServletResponse response) {
//
//        JWTClaimsSet claims = (JWTClaimsSet) jweAuth.getCredentials();
//
//        // pull out oauth2 tokens
//        String oauth2Access  = claims.getClaim(KEYS_OAUTH2_ACCESS_TOKEN).toString();
//        String oauth2Refresh = claims.getClaim(KEYS_OAUTH2_REFRESH_TOKEN).toString();
//
//        // extract username (or subject) directly from the JWTClaimsSet
//        String username = claims.getSubject(); // or claims.getClaim(KEYS_USERNAME).toString()
//
//        // now build the args[] without needing to pass username in a Pair
//        String[] args = new String[] {
//                username,
//                claims.getClaim(KEYS_EMAIL).toString(),
//                claims.getClaim(KEYS_NAME).toString(),
//                claims.getClaim(KEYS_DEVICE_ID).toString(),
//                signupDto.getEmail(),
//                signupDto.getPassword(),
//                signupDto.getUserType()
//        };
//
//        generateAndSaveRefreshTokenToken(
//                response,
//                args,
//                userId,
//                Pair.of(oauth2Access, oauth2Refresh)
//        );
//    }
//
//
